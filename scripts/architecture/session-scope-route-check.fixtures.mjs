...
import { RATE_SESSION_SCOPE_ROUTE_FIXTURES } from "./session-scope-route-check.fixtures-rate.mjs";
import { TICKET_SESSION_SCOPE_ROUTE_FIXTURES } from "./session-scope-route-check.fixtures-ticket.mjs";

export const SESSION_SCOPE_ROUTE_FIXTURES = [
  ...CORE_SESSION_SCOPE_ROUTE_FIXTURES,
  ...RATE_SESSION_SCOPE_ROUTE_FIXTURES,
  ...TICKET_SESSION_SCOPE_ROUTE_FIXTURES,
