...
import type { NewMailNotificationViewModel } from "@/presentation/features/mail-workspace/new-mail-notification.view-model"; import type { MailConnectivityViewModel } from "@/presentation/features/mail-workspace/mail-connectivity"; import type { MessagePrintViewModel } from "@/presentation/features/mail-workspace/message-print.view-model"; export type { FolderViewModel, MailboxIconName } from "@/presentation/features/mail-workspace/folder.view-model";
...
export interface MailWorkspaceViewProps {
  ...
  readonly searchInput: ChangeEventHandler<HTMLInputElement>; readonly searchValue: string; readonly scheduled: ScheduledSendManagerViewModel; readonly session: MemberSessionViewModel; readonly snooze: MailSnoozeViewModel;
